...
function bootstrap(meta = {}){
    ...
    l.innerText = "©\u00a0" + [...extra_c, "OpenFreeMap", "Natural Earth", "Open Water Software et al.", "Mapterhorn", "OpenStreetMap contributors", "Our World in Data", "GeoNames"].filter(x=>x !== null).join(" ©\u00a0")
