...
-- testing that updates via websockets work (they do)
select index, randCanonical() value from '2026-03-01.csv' into outfile 'scratch.csv' truncate format CSVWithNames
